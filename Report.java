...
public class Report {
    ...
    private void CreateReportInfo() {
        ...
        PdfDocumentInfo docinfo = new PdfDocumentInfo(pdf);
        docinfo.setAuthor("Yannis Exidaridis");
        docinfo.setCreator("Yannis Exidaridis");
        docinfo.setKeywords("music, albums");
        docinfo.setTitle(TITLE);
        docinfo.setSubject("Music Albums Compilation");
        docinfo.addCreationDate();               
